...
$arquivofoto = ',foto_produto="'.$arquivo['name'].'"';
...
$stmt =$conn->prepare("update produto set nome_produto = ?,preco = ? 
  $arquivofoto where id_produto = ? ");
...
<meta http-equiv="refresh" content=2;url="http://localhost:8080/infotec/Produto.php">
	<title>Produto</title>
...
<div class="jumbotron"> 
   <h2 style="color:#4169E1" align="center">Produto alterado</h2>
